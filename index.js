(function (global, factory) {
    ...
    function event() {
        ...
        this.metadata.event.forEach(function (event, i) {
            event.order = parseInt(
                _this.data.find(function (d) {
    ...
    function defineMetadata() {
        ...
        this.metadata.orbits = d3
            ...
            .entries(
                this.metadata.event.filter(function (event) {
    ...
    function updateData() {
        ...
        this.data.nested.forEach(function (d) {
            ...
            if (
                d.next_move_time === _this.settings.timepoint &&
                _this.settings.timepoint < d.duration
            ) {
            ...
            var stateChanges = d3.sum(
                d.events.filter(function (event) {
            ...
            d.r =
                _this.settings.eventChangeCountAesthetic !== 'color'
                    ? Math.min(_this.settings.minRadius + stateChanges, _this.settings.maxRadius)
                    : _this.settings.minRadius;
            d.color =
                _this.settings.eventChangeCountAesthetic !== 'size'
                    ? _this.settings.color(stateChanges)
                    : '#aaa';
    ...
    function updateText() {
        ...
        if (this.settings.eventCount)
            this.fociLabels.selectAll('tspan.actpct').text(function (d) {
                return ''
                    .concat(d.count, ' (')
                    .concat(d3.format('%')(d.count / _this.data.nested.length), ')');
            }); // Update notes
    ...
    function step() {
        ...
        inputs.on('click', function () {
            ...
            _this.pause_timeout = setTimeout(
                resume_for_a_while.bind(_this),
    ...
    function colorSizeToggle() {
        ...
        var inputs = container
            ...
            .attr('title', function (d) {
                return 'Quantify the number of times '.concat(
                    'this.settings.eventsToCount',
                    ' have occured by ',
    ...
    function addOrbits() {
        ...
        var orbits = this.svg
            ...
            .attr('fill', 'none')
            .attr('stroke', '#aaa')
            .attr('stroke-width', '.5'); // Annotate concentric circles.
        //this.svg
    ...
    function color$1() {
        ...
        this.colorLegend
            ...
            .html(
                'Number of <span class = "fdg-measure">'.concat(
                    this.settings.eventChangeCount.join(', ').replace(/, ([^,]*)$/, ', and $1'),
                    '</span> events'
                )
            );
        var colorLegendSvg = this.colorLegend
            .append('svg')
        ...
        colorLegendSvg
            ...
            .attr('y', legendDimensions[1] / 2 + 16)
            .attr('text-anchor', 'middle')
            .text(''.concat(this.settings.colors().length, '+'));
    }
    ...
    function size() {
        ...
        var sizeLegendSvg = this.sizeLegend
            .append('svg')
            .attr('width', legendDimensions[0])
            .attr('height', legendDimensions[1])
            .append('g');
    ...
    function both() {
        ...
        var bothLegendSvg = this.bothLegend
            .append('svg')
            .attr('width', legendDimensions[0])
            .attr('height', legendDimensions[1])
            .append('g');
            ...
            .rollup(function (nest) {
                ...
                return {
                    ...
                    r:
                        _this.settings.eventChangeCountAesthetic !== 'color'
                            ? Math.min(
                                  _this.settings.minRadius + stateChanges,
                                  _this.settings.maxRadius
                              )
                            : _this.settings.minRadius,
                    color:
                        _this.settings.eventChangeCountAesthetic !== 'size'
        ...
        return function (d) {
            ...
            var r =
                fdg.settings.eventChangeCountAesthetic !== 'color'
                    ...
                    : d.r + fdg.settings.minRadius + fdg.settings.padding; // dimensions of current node expressed as the coordinates of the corners of a square
                ...
                if (quad.point && quad.point !== d) {
                    ...
                    var minDistance =
                        ...
                        (d.currentEvent.event !== quad.point.currentEvent.event) *
                            fdg.settings.padding; // If the Euclidean distance is less than the minimum distance allowed:
