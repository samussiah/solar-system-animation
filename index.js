(function (global, factory) {
    ...
    function draw(worker, color) {
      ...
      worker.onmessage = function (event) {
        ...
        var marks = g.selectAll('.fdg-static__mark').data(event.data.nodes).join(main.settings.shape === 'circle' ? 'circle' : 'rect').classed('fdg-static__mark', true).attr('fill', event.data.color).attr('fill-opacity', 0.25);
    ...
    */
    ...
    function addForceSimulation() {
      ...
      .force('charge', forceManyBodyReuse().strength(this.settings.chargeStrength)) //.force('charge', forceManyBodySampled().strength(this.settings.chargeStrength * 5))
