(function (global, factory) {
    ...
    function progress() {
      ...
      this.containers.progressDay.style('right', "".concat(100 - this.settings.progress * 100, "%")).text("Day ".concat(this.settings.timepoint)); // Update timer.

      this.containers.timer.text("".concat(this.settings.timepoint, " ").concat(this.settings.timeUnit)); // Update progress pie.
      ...
      this.containers.stopwatch.percentForeground.text(this.settings.progress < 0.0095 ? d3.format('.1%')(this.settings.progress) : d3.format('.0%')(this.settings.progress)); // Update timepoint control.
    ...
    function categorical() {
      ...
      var legendItems = container.append('svg').attr('width', 200).attr('height', 20 * this.scales.color.domain().length).selectAll('g').data(this.scales.color.domain()).join('g');
    ...
    function shape$2() {
      ...
      var legendItems = container.append('svg').attr('width', 200).attr('height', 20 * this.scales.shape.domain().length).selectAll('g').data(this.scales.shape.domain()).join('g');
      var radius = 7;
      var spacing = 20;
