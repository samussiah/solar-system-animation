(function (global, factory) {
    ...
    function sidebar(main) {
        ...
        var events = this.util.addElement('events', container).html(this.settings.individualLabel);
        ...
        data.nested.forEach(function (d, i) {
            ...
            if (
                ...
                (_this.settings.enforceFocusVicinity === false ||
                    ...
                    d.value.state.event === _this.settings.eventCentral)
            ) {
        ...
        var cells =
            this.settings.freqTable.structure === 'vertical'
                ...
                : [
                      ...
                      _toConsumableArray(
                          d.foci
                              ? d.foci.map(function (focus) {
                                    return _this.settings.freqTable.countType === 'id'
    ...
    function makeLegend(type) {
        ...
        var svg = container
            ...
            .append('g')
            .attr('transform', 'translate(23,0)'); // marks
    ...
    function legendTable(label, domain) {
        ...
        container.labels = container.rows.append('td').html(function (d) {
            return d;
    ...
    function addLegends() {
        ...
        this.legends.shape = shape$1.call(this);
    }
            ...
            var td = tr
                ...
                .attr('class', function (d, i) {
                    return main.settings.freqTable.structure === 'vertical'
                        ? 'fdg-freq-table__td--'.concat(
                              i === 0 ? 'label' : i === 1 ? 'individual' : i === 2 ? 'event' : i
                          )
                        : 'fdg-freq-table__td--'.concat(i === 0 ? 'label' : 'freq');
                })
