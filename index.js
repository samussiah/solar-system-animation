(function (global, factory) {
    ...
    function eventMetadata() {
      ...
      this.metadata.event.forEach(function (event) {
        ...
        event.countProportionFmt = "".concat(event.countFmt, " (").concat(event.proportionFmt, ")");
    ...
    function circle(legendItem, i, spacing, radius) {
      legendItem.append('circle').attr('cx', spacing).attr('cy', i * spacing + 10).attr('r', radius).attr('fill', 'none').attr('stroke', '#444');
    }

    function square(legendItem, i, spacing, radius) {
      legendItem.append('rect').attr('x', spacing - radius).attr('y', i * spacing + radius / 2).attr('width', radius * 2).attr('height', radius * 2).attr('fill', 'none').attr('stroke', '#444');
    }
    ...
    function triangle(legendItem, i, spacing, radius) {
      ...
      legendItem.append('polygon').attr('points', [top, left, right]) //.attr('x', spacing - radius)
      //.attr('y', i * spacing)
      //.attr('width', radius * 2)
    ...
    function diamond(legendItem, i, spacing, radius) {
      var x = spacing;
      var y = i * spacing;
      legendItem.append('rect').attr('transform', "rotate(45 ".concat(x, " ").concat(y, ")")).attr('x', x).attr('y', y).attr('width', radius * 2).attr('height', radius * 2).attr('fill', 'none').attr('stroke', '#444');
    }
    ...
    function addFreqTable() {
      ...
      freqTable.tr = freqTable.tbody.selectAll('tr').data(this.data.freqTable) //.filter(d => d.state !== this.settings.eventCentral))
