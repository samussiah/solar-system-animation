(function (global, factory) {
    ...
    function addTimer() {
        ...
        if (this.settings.timepoint > this.settings.reset) {
            ...
            if (
                this.settings.timepoint === this.settings.annotations[this.notes_index].start_minute
            ) {
                this.annotations
                    .style('top', '0px')
                    .transition()
    ...
    function step() {
        ...
        inputs.on('click', function () {
            ...
            _this.timer.text(
                ''.concat(_this.settings.timepoint + 1, ' ').concat(_this.settings.timeUnit)
            );
    ...
    function colorSizeToggle() {
        ...
        var inputs = container
            ...
            .attr('class', function (d) {
                return 'togglebutton '
                    .concat(d, ' ')
                    .concat(d === _this.settings.quantifyEvents ? 'current' : '');
            })
            .text(function (d) {
                return d;
            });
    ...
    function dataManipulation() {
        ...
        this.settings.reset =
            this.settings.reset ||
            d3.max(this.data.nested, function (d) {
                return d.duration;
            });
    }
    ...
    function addOrbits() {
        ...
        var orbits = this.svg
            ...
            .data(
                this.eventTypes.slice(1).map(function (eventType, i) {
