(function (global, factory) {
  ...
  function canvas(main) {
    ...
    var svgBackground = this.util.addElement('svg--background', animation, 'svg').attr('width', main.node().clientWidth).attr('height', this.settings.height).style('position', 'absolute').style('left', -this.settings.widthDiff).style('top', 0); // canvas - bubbles
  ...
  function resize() {
    ...
    this.containers.svgBackground.attr('width', this.settings.fullWidth).attr('height', this.settings.height).style('left', -this.settings.widthDiff); // canvas
    ...
    this.containers.svgBackground.select('g.fdg-g--orbits').attr('transform', "translate(".concat(this.settings.widthDiff, ",0)")); // focus coordinates
  ...
  function shape$2() {
    ...
    if (this.settings.shapify) {
      ...
      legendItems.append('text').classed('fdg-legend__label', true).attr('font-size', '1rem').attr('x', 35).attr('y', function (d, i) {
        return i * 20 + 12;
      }).attr('dy', 0).attr('alignment-baseline', 'middle').html(function (d) {
  ...
  function addOrbits() {
    var g = this.containers.svgBackground.append('g').classed('fdg-g fdg-g--orbits', true).attr('transform', "translate(".concat(this.settings.widthDiff, ",0)"));
