(function (global, factory) {
    ...
    function updateData() {
        ...
        this.data.nested.forEach(function (d) {
            ...
            if (
                d.value.nextStateChange === _this.settings.timepoint &&
                _this.settings.timepoint < d.value.duration
            ) {
    ...
    function nestData() {
        ...
        var nestedData = d3
            ...
            .rollup(function (group) {
                ...
                var initialPointCoordinates = calculateInitialPointCoordinates.call(
                    _this,
                    populationEvent
                ); // Count state changes
