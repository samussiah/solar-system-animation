...
const settings = {
    ...
    explanation: [
        ...
        'As individuals experience events, their bubble gravitates toward the focus or "planet" representing that event.',
        'The number of events an individual experiences dictates the color and/or size of the bubbles.',
